                    ...
                    <Grid item xs={12} md={4} pt={1} pb={4}>
                        <Box sx={{height: '100%'}} display={'flex'} flexDirection={'column'}
                            ...
                            <Link aria-label={'تک جنرال'} href={'/'}>
                                <Box sx={{mb: 1}}>
                                    <Image loading={'lazy'} alt={'تک جنرال'} src={logo} width={150} height={50}/>
                                </Box>
                            </Link>
                            ...
                            <Link title={'Takgeneral.com@gmail.com'} aria-label={'Takgeneral.com@gmail.com'} passHref target={'_blank'}
                        ...
                        <Box height={'100%'} display={'flex'}
                            ...
                            <Box sx={{height: '100%'}} display={'flex'} justifyContent={'space-between'}
                                ...
                                <Link title={'تک جنرال'} aria-label={'تک جنرال'} href={'/'}>
                                    <Typography component={'p'} variant={'h4'} fontWeight={'bold'} mb={2}>تک جنرال</Typography>
                                </Link>
                                <Link title={'درباره ما'} aria-label={'درباره ما'} href={'/about-us'}>
                                    <Typography component={'p'} variant={'h4'} mb={2}>درباره ما</Typography>
                                </Link>
                                <Link title={'تماس با ما'} aria-label={'تماس با ما'} href={'/contact-us'}>
                                    <Typography component={'p'} variant={'h4'} mb={2}>تماس با ما</Typography>
                                </Link>
                            ...
                            <Box sx={{height: '100%'}} display={'flex'} justifyContent={'space-between'}
                                 alignItems={{md: 'start', xs: 'center'}} flexDirection={'column'}>
                                <Typography variant={'h6'} component={'p'} fontWeight={'bold'} mb={2}>خدمات مشتریان</Typography>
                                <Typography variant={'h6'} component={'p'} mb={2}>قوانین و مقررات</Typography>
                                <Typography variant={'h6'} component={'p'} mb={2}>سوالات متداول</Typography>
                                <Typography variant={'h6'} component={'p'}>پیگیری سفارشات</Typography>
                            </Box>
                        </Box>
                    </Grid>
                    <Grid item xs={12} md={4}>
                        <Box display={'flex'} justifyContent={'center'} gap={4}>
                            <Box width={86} height={94} sx={{
                                ...
                                <Image unoptimized={true} referrerPolicy='origin' width={86} height={94} id='rgvjwlaooeukwlaofukzoeuk' style={{cursor: 'pointer'}}
                                       onClick={()=> {
