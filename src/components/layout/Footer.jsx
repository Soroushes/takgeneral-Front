                ...
                <Grid container sx={{justifyContent: 'space-between' , pb:{xs:2 , md:0}, display: 'flex', borderBottom: '1px solid #eee'}}>
                    ...
                    <Grid item xs={12} md={3} py={4}>
                        <Box height={'100%'} display={'flex'}
                            ...
                            <Box sx={{height: '100%',gap:{xs:2 , md:0}}} display={'flex'} justifyContent={'space-between'}
                                 alignItems={{md: 'start', xs: 'center'}} flexDirection={'column'}>
                                <Typography variant={'h6'} component={'p'} fontWeight={'bold'}>خدمات مشتریان</Typography>
                                <Typography variant={'h6'} component={'p'}>قوانین و مقررات</Typography>
                                <Typography variant={'h6'} component={'p'}>سوالات متداول</Typography>
