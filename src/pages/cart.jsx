                ...
                <Grid container rowGap={1}>
                    ...
                    <Grid item md={8} lg={8.5} xs={12}>
                        <Grid container sx={{mb:1}}>
                            <Grid xs={12} item sx={{display :{lg :'flex' , xs:'none'} , backgroundColor :'#fff' , py :1.5 , borderRadius :3  }}>
                    ...
                    <Grid sx={{pl : {md : 3} }} item md={4} lg={3.5} xs={12}>
                        <Grid sx={{backgroundColor:'#fff'  , p:2 , borderRadius :3  ,mb:2 , gap:3 , p:3}} container>
                            ...
                            <Grid item xs={12} sx={{display:'flex' , justifyContent:'center'}}>
                                <Button variant={'contained'} color={'secondary'} sx={{textAlign:'center'  , width:'100%' , borderRadius:2}}>ثبت  سفارش</Button>
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
